...
export const SIMI = {
  ...
  reasons: [
    "Reason 1 — placeholder",
    "Reason 2 — placeholder",
  ...
  realization: {
    ...
    story:
      "The day I realized you were special… [write the moment here — the look, the laugh, the silence that said everything].",
  },
  ...
  timeline: [
    ...
    { date: "Date 5", memory: "Memory placeholder", comment: "My little note about this day." },
  ],
