...
export const SIMI = {
  ...
  simi: [
    { emoji: "🌸", title: "Nature Lover", text: "You see beauty in every petal, every leaf, every quiet morning." },
    { emoji: "🎨", title: "Artist & Creator", text: "Your hands turn colors into feelings. Your art is a kind of magic." },
    { emoji: "🎵", title: "Music Lover", text: "Music lives in you — in the way you hum, the way you listen, the way you feel." },
    { emoji: "💙", title: "Sky Blue Soul", text: "Calm, warm, endless. You're the color of a clear afternoon sky." },
    { emoji: "🌱", title: "Plant Mom", text: "Everything you touch grows — flowers, friendships, hearts." },
  ],
