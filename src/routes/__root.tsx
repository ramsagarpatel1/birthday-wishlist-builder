...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,500;0,700;1,500&family=Fredoka:wght@400;500;600&family=Quicksand:wght@400;500;600&family=Caveat:wght@400;600;700&display=swap",
      },
    ],
  }),
